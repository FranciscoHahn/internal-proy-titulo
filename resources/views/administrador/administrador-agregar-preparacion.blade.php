    ...
    <main style="margin-top: 58px;">
        <div class="container pt-4">
            <div class="d-flex justify-content-between mt-1">
                <h3 class="me-3">Creación de preparación</h3>
            ...
            <div class="mt-4">
                <form method="POST" action="{{ route('agregandopreparacion') }}">
                    <div class="row">
                        ...
                        <div class="mb-4 col-5">
                            ...
                            <div class="form-outline mb-4">
                                <input type="number" id="form6Example2" class="form-control" name="precio"
                                    value="{{ isset($data_preparacion) ? $data_preparacion['precio'] : '' }}" />
                    ...
                    <!-- Submit button -->
                    <button type="submit" class="btn btn-primary btn-block mb-4">Crear preparación</button>
                </form>
